...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        ...
        <span class="ms-1 font-weight-bold text-white">Super Admin</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "tangos.php"? 'active bg-gradient-primary':''; ?>" href="tangos.php">
            ...
            <span class="nav-link-text ms-1">Barangay Tangos</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "tanza1.php"? 'active bg-gradient-primary':''; ?>" href="tanza1.php">
            ...
            <span class="nav-link-text ms-1">Barangay Tanza 1</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "tanza2.php"? 'active bg-gradient-primary':''; ?>" href="tanza2.php">
            ...
            <span class="nav-link-text ms-1">Barangay Tanza 2</span>
          </a>
      </ul>
    </div>
