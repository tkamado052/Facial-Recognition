...
<head>
    ...
    <title>Barangay Tanza Uno</title>
...
<body>
    ...
    <div class="sidebar">
        <header>Barangay Tanza Uno</header>
        <ul>
            <li><a href="#">Graphs</a></li>
            <li><a href="../tanzaUno/tanzaUno.php">PWDs</a></li>
            <li><a href="../tanzaUno/tanzaUno.php">Senior Citizens</a></li>
            <li><a href="../tanzaUno/tanzaUno.php">Solo Parents</a></li>
        </ul>
        <ul>
